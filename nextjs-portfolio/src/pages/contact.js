...
function contact() {
  ...
  return (
    ...
    <div className="dark:bg-zinc-900 bg-zinc-100 min-h-screen transition-colors duration-1000 ease-in-out pb-24 cursor-default ">
      <h1 className="flex text-center mx-auto justify-center text-2xl md:text-4xl">Let's <span className="dark:text-cyan-300 text-cyan-500">&nbsp;Work Together</span></h1>
      <div className="flex justify-center">
        <div className=" mx-8 mt-12 grid grid-cols-1 w-9/12 md:w-6/12">
