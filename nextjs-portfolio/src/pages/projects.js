    ...
    <>
      <div className="min-h-screen  dark:bg-zinc-900 bg-zinc-100 transition-colors duration-1000 ease-in-out">
        ...
        <div className="flex justify-center items-center mx-8">
          <div className="grid sm:grid-cols-2 gap-4 justify-center items-center h-full overflow-hidden md:mx-12">
            <motion.div
              className="md:h-6/12 border-2 md:border-4 dark:border-white border-black hover:border-cyan-600 hover:dark:border-cyan-300 rounded-md md:w-6/12 relative md:mx-auto"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2 }}
              exit={{ opacity: 0, y: 10 }}
            >
              <img className="w-[1300px]" src="https://media.discordapp.net/attachments/1093897626920964186/1093898295623032922/minecomm.png?width=1154&height=673" alt="MineCommunity" />
              <div className="absolute inset-0 dark:bg-zinc-800  opacity-0 hover:opacity-95 transition-opacity duration-300 md:flex hover:bg-slate-100 dark:rounded-md rounded-sm hidden">
                <motion.span whileHover={{ opacity: 1 }} className="  mt-4 mx-4">
            ...
            <motion.div
              className="md:min-h-full bg-white border-2 md:border-4 dark:border-white border-black hover:border-cyan-600 hover:dark:border-cyan-300 rounded-md md:w-6/12 relative md:mx-auto"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2 }}
              exit={{ opacity: 0, y: 10 }}
            >
              <img className="w-[1300px]" src="https://cdn.discordapp.com/attachments/1093897626920964186/1093988969429082203/cypherchats.png" alt="MineCommunity" />
              <div className="absolute inset-0 dark:bg-zinc-800  opacity-0 hover:opacity-95 transition-opacity duration-300 md:flex hover:bg-slate-100 dark:rounded-md rounded-sm hidden">
                <motion.span whileHover={{ opacity: 1 }} className="  mt-4 mx-4 mb-8">
