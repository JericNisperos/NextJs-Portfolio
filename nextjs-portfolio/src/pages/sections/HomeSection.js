    ...
    <div className="min-h-screen">
      <div>
        ...
        <div className="flex md:pt-48 ">
          {/* <FrontSection /> */}
          <div className="grid grid-cols-1 md:grid-cols-4 md:gap-4 max-w-8xl px-8 mt-12 z-20 ml-24">
            {/* <motion.img
            ...
            <motion.div className="col-span-3 sm:flex sm:flex-col justify-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.2 }}>
              ...
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1.5 }} className=" md:text-2xl md:mt-4 text-center md:text-left">Building dynamic and responsive web applications.</motion.p>
